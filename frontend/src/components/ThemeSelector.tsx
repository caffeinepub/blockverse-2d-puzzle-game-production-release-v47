                ...
                >
                    ...
                    >
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-medium text-sm sm:text-base">{t('theme.light')}</span>
                        </div>
                    </DropdownMenuItem>
                    <DropdownMenuItem
                    ...
                    >
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-medium text-sm sm:text-base">{t('theme.dark')}</span>
                        </div>
                    </DropdownMenuItem>
                    <DropdownMenuItem
                    ...
                    >
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-medium text-sm sm:text-base">{t('theme.neon')}</span>
                        </div>
                    </DropdownMenuItem>
                </DropdownMenuContent>
            </DropdownMenu>
