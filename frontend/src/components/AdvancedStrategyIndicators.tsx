...
export function AdvancedStrategyIndicators({
    ...
    return (
        <div className="w-full flex flex-col gap-1 sm:gap-2">
            {showFallingBlockWarning && (
                <div className={`flex items-center justify-center gap-2 px-3 py-1.5 sm:py-2 rounded-lg border-2 ${getWarningClass()} animate-pulse`}>
            ...
            {powerUpChainActive && (
                <div className={`flex items-center justify-center gap-2 px-3 py-1.5 sm:py-2 rounded-lg border-2 ${getChainClass()} animate-pulse`}>
