...
export function DailyRewardModal({ theme, onClaim }: DailyRewardModalProps) {
    ...
    const getRewardDescription = () => {
        ...
        if (reward.type === 'points') {
            return t('dailyReward.pointsReward').replace('{points}', reward.points?.toString() || '0');
                ...
                <div className="space-y-6 py-4">
                    ...
                    <div className="flex items-center justify-center gap-2">
                        ...
                        <span className="text-lg font-semibold">
                            {t('dailyReward.streak').replace('{days}', reward.streak.toString())}
                        </span>
                        {reward.multiplier > 1 && (
                    ...
                    <div className="relative">
                        <div className={`p-6 rounded-lg border-2 ${
                            theme === 'light' ? 'bg-white border-purple-300' :
