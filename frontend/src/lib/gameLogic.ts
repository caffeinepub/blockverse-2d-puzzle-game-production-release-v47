...
export function clearLines(board: (number | string)[][]): { clearedBoard: (number | string)[][]; linesCleared: number } {
...
export function checkGameOver(board: (number | string)[][], blocks: BlockShape[]): boolean {
