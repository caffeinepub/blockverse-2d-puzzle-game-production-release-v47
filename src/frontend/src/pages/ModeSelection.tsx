...
export function ModeSelection({ onModeSelect }: ModeSelectionProps) {
  ...
  const modes: Array<{
  ...
  }> = [
    {
      id: "timeAttack",
      icon: Clock,
      iconSrc: "/assets/generated/time-attack-icon-transparent.dim_128x128.png",
    },
    {
      id: "endless",
      icon: InfinityIcon,
      iconSrc:
        "/assets/generated/endless-mode-icon-transparent.dim_128x128.png",
    },
    {
      id: "strategy",
      icon: Target,
      iconSrc:
        "/assets/generated/strategy-mode-icon-transparent.dim_128x128.png",
    },
    {
      id: "powerBoost",
      icon: Zap,
      iconSrc: "/assets/generated/power-boost-icon-transparent.dim_128x128.png",
    },
    {
      id: "advancedStrategy",
      icon: Sparkles,
      iconSrc:
        "/assets/generated/advanced-strategy-mode-icon-transparent.dim_128x128.png",
    },
  ];
  ...
  return (
    <div
      className={`min-h-[100dvh] flex flex-col ${getBackgroundGradientClass()} relative overflow-hidden`}
    >
      {/* Animated particles */}
      ...
      <div className="relative z-10 pb-4 px-4">
        <div className="container mx-auto max-w-5xl">
          <MobileNativeAd theme={theme} className="w-full" />
        </div>
      </div>
