...
export const LEVEL_CONFIGS: { [key: number]: LevelConfig } = {
  1: {
    level: 1,
    backgroundImage:
      "/assets/generated/level-1-background-clean.dim_800x600.png",
    particleImage:
      "/assets/generated/level-1-particles-transparent.dim_200x200.png",
  ...
  2: {
    level: 2,
    backgroundImage:
      "/assets/generated/level-2-background-clean.dim_800x600.png",
    particleImage:
      "/assets/generated/level-2-particles-transparent.dim_200x200.png",
  ...
  3: {
    level: 3,
    backgroundImage:
      "/assets/generated/level-3-background-clean.dim_800x600.png",
    particleImage:
      "/assets/generated/level-3-particles-transparent.dim_200x200.png",
  ...
  4: {
    level: 4,
    backgroundImage:
      "/assets/generated/level-4-background-clean.dim_800x600.png",
    particleImage:
      "/assets/generated/level-4-particles-transparent.dim_200x200.png",
  ...
  5: {
    level: 5,
    backgroundImage:
      "/assets/generated/level-5-background-clean.dim_800x600.png",
    particleImage:
      "/assets/generated/level-5-particles-transparent.dim_200x200.png",
...
export function shouldShowLevelTransition(
  oldScore: number,
  newScore: number,
): { shouldShow: boolean; newLevel: number } {
...
export function getBadgeForLevel(
  level: number,
