...
export function addPowerUp(
  ...
  const existingPowerUp = allProgress[userCode].powerUps.find(
    (p) => p.type === type,
  );
  if (existingPowerUp) {
...
export function getBadgeForLevel(level: number): {
  ...
  if (level >= 9)
    return {
      name: "Diamond",
      image: "/assets/generated/diamond-badge-transparent.dim_128x128.png",
    };
  if (level >= 7)
    return {
      name: "Platinum",
      image: "/assets/generated/platinum-badge-transparent.dim_128x128.png",
    };
  if (level >= 5)
    return {
      name: "Gold",
      image: "/assets/generated/gold-badge-transparent.dim_128x128.png",
    };
  if (level >= 3)
    return {
      name: "Silver",
      image: "/assets/generated/silver-badge-transparent.dim_128x128.png",
    };
  return {
    name: "Bronze",
    image: "/assets/generated/bronze-badge-transparent.dim_128x128.png",
  };
}
